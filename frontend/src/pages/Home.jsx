    ...
    <div className="space-y-24 py-10">
      ...
      <section className="relative text-center space-y-8 max-w-4xl mx-auto px-4">
        ...
        <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-white leading-tight">
          Advanced AI Diagnostic Intelligence for <span className="bg-gradient-to-r from-sky-400 via-indigo-300 to-teal-300 bg-clip-text text-transparent">Radiology & Clinical Care</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
          <Link
            to="/register"
            className="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-gradient-to-r from-sky-500 to-indigo-600 hover:from-sky-400 hover:to-indigo-500 text-white font-bold shadow-xl shadow-sky-500/25 flex items-center justify-center space-x-2 transition-all transform hover:-translate-y-0.5"
          >
          ...
          <Link
            to="/login"
            className="w-full sm:w-auto px-8 py-3.5 rounded-xl glass-panel hover:bg-slate-800/60 text-slate-200 font-semibold border border-slate-700 flex items-center justify-center transition"
          >
            Log In to Account
          </Link>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold text-white">Enterprise Diagnostic Capabilities</h2>
          <p className="text-slate-400 text-sm mt-2">Engineered for precision, explainability, and seamless workflow integration</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="glass-panel glass-panel-hover p-8 rounded-2xl space-y-4">
            ...
            <h3 className="text-xl font-bold text-white">EfficientNet-B0 DL Model</h3>
          ...
          <div className="glass-panel glass-panel-hover p-8 rounded-2xl space-y-4">
            ...
            <h3 className="text-xl font-bold text-white">Grad-CAM Visual Heatmaps</h3>
            <p className="text-slate-400 text-sm leading-relaxed">
          ...
          <div className="glass-panel glass-panel-hover p-8 rounded-2xl space-y-4">
            ...
            <h3 className="text-xl font-bold text-white">LLM Medical Reports</h3>
            <p className="text-slate-400 text-sm leading-relaxed">
        ...
        <div className="glass-panel p-8 sm:p-12 rounded-3xl border border-slate-800 space-y-8">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div className="space-y-2 max-w-xl">
              <h3 className="text-2xl font-bold text-white">Full-Stack Enterprise Architecture</h3>
              <p className="text-slate-400 text-sm">FastAPI REST Services • Async PyMongo MongoDB Repository • PyTorch Deep Learning • React 18 & Tailwind CSS</p>
            </div>
            <div className="flex items-center space-x-4">
              <div className="px-4 py-2 rounded-xl bg-slate-900 border border-slate-700 text-xs font-mono text-sky-400">
                FastAPI v0.104
              </div>
              <div className="px-4 py-2 rounded-xl bg-slate-900 border border-slate-700 text-xs font-mono text-indigo-400">
                PyTorch v2.1
              </div>
              <div className="px-4 py-2 rounded-xl bg-slate-900 border border-slate-700 text-xs font-mono text-teal-400">
                MongoDB Atlas
              </div>
            </div>
          </div>
